...
#pragma warning restore 649
    ...
    public static class Orm
    {
        ...
        public static string SqlType(TableMapping.Column p, bool storeDateTimeAsTicks)
        {
            ...
            if (clrType == typeof(bool)  || clrType == typeof(byte) || clrType == typeof(ushort) || clrType == typeof(sbyte) ||
                clrType == typeof(short) || clrType == typeof(int))
                return "integer";
    ...
    public static class SQLite3
    {
        ...
        public static extern Result Prepare2(IntPtr db, [MarshalAs(UnmanagedType.LPStr)] string sql, int numBytes, out IntPtr stmt,
                                             IntPtr pzTail);
